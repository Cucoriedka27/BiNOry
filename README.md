...
- if the void is read it gives a random value, if a value is put into the void it deletes the value

### Instructions

- `1` Pushes the value 1 on top of the stack.
- `0` Pops the top value on the stack and does an operation based on the following opcode table, incorrect opcodes should be treated as noops

|opcode|name|description|
|:----:|:-:|-----------|
|`0`|Pop|Pops the top value|
|`1`|Add|Pops the top 2 values, adds them together, and pushes the result onto the stack|
...
## Examples
- Hello World by Čučoriedka
- Calculator by purpletissuebox